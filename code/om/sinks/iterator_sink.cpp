...
// MARK: Om::Sinks::IteratorSink
	...
	#define Type_ Om::Sinks::IteratorSink< ThisItem, ThisIterator >
...
{
	boost::swap( this->thisIterator, theIteratorSink.thisIterator );
	return( *this );
}
...
inline void boost::swap(
	Om::Sinks::IteratorSink< ThisItem, ThisIterator > & theFirst,
	Om::Sinks::IteratorSink< ThisItem, ThisIterator > & theSecond
)
{
