...
*/
	...
	All global preprocessor definitions (excluding include guards) should use
	this namespace to avoid clashes, regardless of where they are physically
	defined.
	*/
	#define Om_Macros_ Om::Macros

	//! Prepends <code>0x</code>.
	#define Om_Macros_PrependZeroX_( theArgument ) 0x ##theArgument
	...
	#define Om_Macros_GetNumber_( theHex ) Om_Macros_PrependZeroX_( theHex )
