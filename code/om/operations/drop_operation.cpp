...
inline bool Type_::ReadQuotedElements( Evaluator &, Parser & theParser )
{
...
inline bool Type_::TakeOperand( Evaluator &, TheOperand & )
{
	return( true );
}

template< typename TheQueue >
inline bool Type_::TakeQuotedQueue( Evaluator &, TheQueue & )
{
	return( true );
}
