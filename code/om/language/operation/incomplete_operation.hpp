...
#ifndef Om_Language_Operation_IncompleteOperation_

	#define Om_Language_Operation_IncompleteOperation_ \
	Om::Language::Operation::IncompleteOperation
...
namespace Om {
	...
	namespace Language {
		...
		namespace Operation {
			...
			// MARK: - Om::Language::Operation::IncompleteOperation
	...
	#include "om/language/operation/incomplete_operation.cpp"
