...
#ifndef Om_Language_Evaluation_

	#define Om_Language_Evaluation_ \
	Om::Language::Evaluation
...
namespace Om {
		...
		*/
		...
		public: // MARK: public (non-static)
			...
			*/
			...
			/*!
			\brief
				Pushes the produced \ref Language::Element "Elements" onto the front of the Expression, last first.
			*/
	...
	#include "om/language/evaluation.cpp"
