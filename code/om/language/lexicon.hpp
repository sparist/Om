...
\defgroup om__lexicon__ Lexicon
	...
	\par Interpretation
		A \ref om__program__ is interpreted as a \ref om__lexicon__ by treating it as a sequence of \ref om__operator__ and \ref om__operand__ pairs that map \ref om__operator__ "Operators" to \ref om__operand__ "Operands" as follows:
	...
	\par Normalization
		...
		-	Each \ref om__separator__ is removed, and a line \ref om__separator__ is inserted between each \ref om__operator__ and \ref om__operand__ pair.
