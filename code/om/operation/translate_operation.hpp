...
#ifndef Om_Operation_TranslateOperation_

	#define Om_Operation_TranslateOperation_ \
	Om::Operation::TranslateOperation
...
namespace Om {
	...
	namespace Operation {
		...
		// MARK: - Om::Operation::TranslateOperation
	...
	#include "om/operation/translate_operation.cpp"
