...
*/
	...
	#define Om_Sources_ContainerBackSource_ Om::Sources::ContainerBackSource
...
namespace Om
{
	namespace Sources
	{
		...
		*/
		...
		DefaultSource<
			ThisItem,
			ContainerBackSource< ThisItem, ThisContainer >
		>
		{
...
namespace boost
{
	template< typename ThisItem, typename ThisContainer >
	void swap(
		Om::Sources::ContainerBackSource< ThisItem, ThisContainer > &,
		Om::Sources::ContainerBackSource< ThisItem, ThisContainer > &
	);
}
