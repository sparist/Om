...
*/
	...
	#define Om_Operation_BackPullSeparatorOperation_ \
	Om::Operation::BackPullSeparatorOperation

	#include "om/system.hpp"

	#define Om_Operation_BackPullSeparatorOperation_GetName_() \
	"[elements|separator]->"
...
namespace Om {
	...
	#include "om/operation/back_pull_separator_operation.cpp"
